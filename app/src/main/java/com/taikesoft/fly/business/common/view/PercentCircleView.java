...
public class PercentCircleView extends View {
    ...
    private int textGrayColor = ContextCompat.getColor(getContext(), R.color.app_color_gray);
    private int textBlueColor = ContextCompat.getColor(getContext(), R.color.app_color_blue);
