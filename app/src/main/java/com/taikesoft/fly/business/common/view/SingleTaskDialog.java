...
import com.taikesoft.fly.ui.child.adapter.SelectTasksAdapter;
...
public class SingleTaskDialog extends Dialog {
    private List<SelectTaskEntity> mSelectList = new ArrayList<>();
    private SelectTasksAdapter mAdapter;
    private Context context;
    private DataBackListener listener;
    private UninterceptableListView mListView;
    private RelativeLayout rlNoData;
    private SelectTaskEntity mSelectType;
    private TextView tvTitle;

    //定义接口
    public interface DataBackListener {
        void getData(SelectTaskEntity entity);
    }

    public SingleTaskDialog(@NonNull Context context, SelectTaskEntity mSelectType, DataBackListener listener) {
    ...
    public SingleTaskDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    protected SingleTaskDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    private void initView() {
        ...
        mAdapter = new SelectTasksAdapter(context);
    ...
    public void setInitSelecList(List<SelectTaskEntity> initSelectList) {
