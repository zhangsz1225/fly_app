...
public class WheelView extends View {
    ...
    private TimePicker.OnWheelListener onWheelListener;
     ...
     */
    @Deprecated
    public final void setOnWheelListener(TimePicker.OnWheelListener listener) {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (onWheelListener != null) {
                    onWheelListener.onHourWheeled(selectedIndex, items.get(selectedIndex).getName());
                    onWheelListener.onMinuteWheeled(selectedIndex, items.get(selectedIndex).getName());
                }
            }
        }, 200L);
    }
     ...
     */
    @Deprecated
    public interface OnWheelViewListener extends TimePicker.OnWheelListener {
    }
