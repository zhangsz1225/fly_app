 ...
 * 儿童列表排序适配器
 */
public class ChildrenSortBtnAdapter extends BaseAdapter implements SectionIndexer {
    private List<ChildInfoEntity> mList;
    ...
    public ChildrenSortBtnAdapter(Context mContext, List<ChildInfoEntity> list, List<ChildInfoEntity> childData) {
     ...
     */
    public void updateListView(/*List<ChildInfoEntity> list*/List<ChildInfoEntity> selectedList) {
        /*if (list == null) {
			this.mList = new ArrayList<>();
		} else {
			this.mList = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final ChildInfoEntity mContent = mList.get(position);
        if (view == null) {
            ...
            viewHolder.btnDetail = (Button) view.findViewById(R.id.btn_child_detail);
            viewHolder.btnRecord = (Button) view.findViewById(R.id.btn_nurse_record);
            viewHolder.btnNurse = (Button) view.findViewById(R.id.btn_nurse);
        ...
        viewHolder.tvGroup.setText(this.mList.get(position).getNursingRoom());
    ...
    private boolean isSelected(ChildInfoEntity model) {
