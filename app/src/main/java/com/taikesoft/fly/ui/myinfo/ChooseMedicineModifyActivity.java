...
public class ChooseMedicineModifyActivity extends BaseActivity implements View.OnClickListener {
                ...
                try {
                    ...
                    if (StringUtils.equals(datas.getState(), ResultStatus.SUCCESS)) {
                        ...
                        if (personList != null && personList.size() != 0) {
                            ...
                            medicineSortadapter = new MedicineSortAdapter(ChooseMedicineModifyActivity.this, sourceDateList, mMedicineDatas);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.tv_titlebar_right:
                ...
                Intent intentTake = new Intent(this, TakeMedicineModifyActivity.class);
                intentTake.putExtra("mMedicineData", (Serializable) selectedList);
                intentTake.putExtra("mRecordBean", mRecordBean);
                intentTake.putExtra("mChildData", (Serializable) mChildren);
                intentTake.putExtra("mDosage", dosage);
                intentTake.putExtra("mMedicineUnit", selectedMedicineUnit);
                this.setResult(2, intentTake);
                startActivity(intentTake);
                closeKeyboard();
                finish();
                TakeMedicineModifyActivity.mTakeActivity.finish();
                break;
            case R.id.rl_my_download:
                List<MedicineInfoEntity> contactsSelectedList = medicineSortadapter.getSelectedList();
                Intent intent = new Intent(this, TakeMedicineModifyActivity.class);
                intent.putExtra("mMedicineData", (Serializable) contactsSelectedList);
                intent.putExtra("mRecordBean", mRecordBean);
                intent.putExtra("mChildData", (Serializable) mChildren);
                intent.putExtra("mDosage", dosage);
                intent.putExtra("mMedicineUnit", selectedMedicineUnit);
