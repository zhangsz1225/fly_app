...
public class ChooseMedicineActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mSpiritType = getIntent().getStringExtra("mSpiritType");
                ...
                try {
                    ...
                    if (StringUtils.equals(datas.getState(), ResultStatus.SUCCESS)) {
                        ...
                        if (personList != null && personList.size() != 0) {
                            ...
                            medicineSortadapter = new MedicineSortAdapter(ChooseMedicineActivity.this, sourceDateList, mMedicineDatas);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.tv_titlebar_right:
                ...
                Intent intentTake = new Intent(this, TakeMedicineActivity.class);
                intentTake.putExtra("mMedicineData", (Serializable) selectedList);
                intentTake.putExtra("mNurseItemBean", mNurseItemBean);
                intentTake.putExtra("mChildData", (Serializable) mChildren);
                intentTake.putExtra("mDosage", dosage);
                intentTake.putExtra("mSpiritType", mSpiritType);
            ...
            case R.id.rl_my_download:
                ...
                intent.putExtra("mSpiritType", mSpiritType);
