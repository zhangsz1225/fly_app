 ...
 * 儿童列表排序适配器
 */
public class ChildrenSortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public ChildrenSortAdapter(Context mContext, List<ChildInfoEntity> list, List<ChildInfoEntity> childData) {
